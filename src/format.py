...
Example usage:
    ...
    python yml_formatter.py input.yml --inplace
    python yml_formatter.py /path/to/folder --inplace
    python yml_formatter.py input.yml --output formatted.yml --char-limit 100
